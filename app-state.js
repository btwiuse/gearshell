...
export function setTerminalLayer(value) { terminalLayer = value; }
...
export function setSystemReady(value) { systemReady = value; }
export let wanixSystem = null;
export function setWanixSystem(value) { wanixSystem = value; }
