...
export const DEFAULT_PLUGINS = [
  {
    ...
    version: "1.0.0",
    icon: "Music2",
    entry: "/plugin/music/music-plugin.js?v=20260829.26",
    permissions: {
  ...
  },
  {
    ...
    entry: "/plugin/deck/deck-plugin.js?v=20260829.6",
  },
  {
    id: "group",
    name: "Group",
    version: "1.0.0",
    icon: "UsersRound",
    entry: "/plugin/group/group-plugin.js?v=20260829.38",
  },
  {
    id: "runtime",
    name: "Runtime",
    version: "1.0.0",
    icon: "Activity",
    entry: "/plugin/runtime/runtime-plugin.js?v=20260829.55",
  },
  {
    id: "playground",
    name: "Playground",
    ...
    entry: "/plugin/playground/playground-plugin.js?v=20260829.86",
  },
  {
    id: "home",
    name: "Home",
    version: "1.0.0",
    icon: "House",
    entry: "/plugin/home/home-plugin.js?v=20260829.67",
    permissions: {
      api: ["terminal.embed"],
    },
  },
  {
    ...
    version: "1.0.0",
    icon: "FolderOpen",
    entry: "/plugin/files/files-plugin.js?v=20260829.94",
  },
  {
    id: "workbench",
    name: "Workbench",
    version: "1.0.0",
    icon: "Monitor",
    entry: "/plugin/workbench/workbench-plugin.js?v=20260829.95",
  },
  {
    id: "vm",
    name: "VM",
    version: "1.0.0",
    icon: "Cpu",
    entry: "/plugin/vm/vm-plugin.js?v=20260829.96",
  },
  {
    id: "settings",
    name: "Settings",
    version: "1.0.0",
    icon: "Settings",
    entry: "/plugin/settings/settings-plugin.js?v=20260829.100",
  },
  {
    id: "launcher",
    name: "Launcher",
    version: "1.0.0",
    icon: "Rocket",
    entry: "/plugin/launcher/launcher-plugin.js?v=20260829.79",
  },
  {
    id: "crush-runner",
    name: "Crush Runner",
    version: "1.0.0",
    icon: "Rocket",
    entry: "/plugin/crush-runner/crush-runner-plugin.js?v=20260829.101",
  },
  {
    id: "browser",
    name: "Browser",
  ...
  // working exactly as before.
  {
    ...
    version: "1.0.0",
    icon: "Dog",
    entry: "/plugin/web-pet/web-pet-plugin.js?v=20260829.33",
  },
  {
    id: "widgetbot",
    name: "Discord Widget",
    version: "1.0.0",
    icon: "MessageSquare",
    entry: "/plugin/widgetbot/widgetbot-plugin.js?v=20260829.6",
  },
  // Bubble Tea playground: a curated subset of the bbtex manifest
  ...
  // profile.cmd = example id. Upgrade the examples by bumping the
  // @v2.0.12 pins below (and the panel list in plugin/bbtex/bbtex.js).
  {
    ...
    version: "1.0.0",
    icon: "Sprout",
    entry: "/plugin/bbtex/bbtex-plugin.js?v=20260830.2",
