/* Gemma 4 E2B (QAT mobile) WebGPU runtime — vendored from webml-community/gemma-4-webgpu-kernels.
   Loaded as a CLASSIC script (not a module) so file:// origins work without CORS fetch.
   Sets globalThis.Gemma4Mobile | GEMMA_DEFAULT_MODEL_ID | Gemma4ResolveModelRoot after load.
   Weights + tokenizer are fetched from the HF Hub (CORS-open) at runtime. */
