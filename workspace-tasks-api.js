...
import { getDockviewApi } from "./app-panels-store.js?v=20260826.55";
import {
  getWanixRoot,
  workspaceTaskSessions,
} from "./app-state.js?v=20260826.2";
import { addWorkspaceTaskPanel } from "./panels.js?v=20260812.44";
import {
  addWorkspaceTask,
  loadActiveWorkspace,
...
import { groupFor } from "./workspace-open-api.js?v=20260828.40";
