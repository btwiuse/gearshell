...
import { getDockviewApi } from "./app-panels-store.js?v=20260826.74";
import {
  getWanixRoot,
  workspaceTaskSessions,
} from "./app-state.js?v=20260826.2";
import { addWorkspaceTaskPanel } from "./panels.js?v=20260812.62";
import {
  addWorkspaceTask,
  loadActiveWorkspace,
...
import {
  normalizeTask,
  validateTask,
} from "./app-normalize-system.js?v=20260828.25";
import {
  markAgentTask,
  markAgentTaskStatus,
} from "./workspace-task-registry.js?v=20260828.59";
import {
  destroyWorkspaceTaskSession,
  getTaskOutput,
  taskLogKernelPath,
} from "./app-workspace-task-sessions.js?v=20260828.80";
import { groupFor } from "./workspace-open-api.js?v=20260828.59";
import { WORKSPACE_TASK_STATUS_EVENT } from "./app-constants.js?v=20260828.33";
