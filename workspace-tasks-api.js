...
import { getDockviewApi } from "./app-panels-store.js?v=20260826.102";
import {
  getWanixRoot,
  workspaceTaskSessions,
} from "./app-state.js?v=20260826.2";
import { addWorkspaceTaskPanel } from "./panels.js?v=20260812.90";
import {
  addWorkspaceTask,
  loadActiveWorkspace,
...
import {
  normalizeTask,
  validateTask,
} from "./app-normalize-system.js?v=20260828.53";
import {
  markAgentTask,
  markAgentTaskStatus,
} from "./workspace-task-registry.js?v=20260828.87";
import {
  destroyWorkspaceTaskSession,
  getTaskOutput,
  taskLogKernelPath,
} from "./app-workspace-task-sessions.js?v=20260828.108";
import { groupFor } from "./workspace-open-api.js?v=20260828.87";
import { WORKSPACE_TASK_STATUS_EVENT } from "./app-constants.js?v=20260828.61";
