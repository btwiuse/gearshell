...
import { getDockviewApi } from "./app-panels-store.js?v=20260826.150";
import {
  getWanixRoot,
  workspaceTaskSessions,
} from "./app-state.js?v=20260826.2";
import { addWorkspaceTaskPanel } from "./panels.js?v=20260812.138";
import {
  addWorkspaceTask,
  loadActiveWorkspace,
...
import {
  normalizeTask,
  validateTask,
} from "./app-normalize-system.js?v=20260828.101";
import {
  markAgentTask,
  markAgentTaskStatus,
...
import { groupFor } from "./workspace-open-api.js?v=20260828.135";
