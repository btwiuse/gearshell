...
import { getDockviewApi } from "./app-panels-store.js?v=20260826.54";
import {
  getWanixRoot,
...
import {
  ...
  getTaskOutput,
  taskLogKernelPath,
} from "./app-workspace-task-sessions.js?v=20260828.60";
import { groupFor } from "./workspace-open-api.js?v=20260828.39";
