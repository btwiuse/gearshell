...
import { openApi } from "./workspace-open-api.js?v=20260828.37";
import { configApi } from "./workspace-config-api.js?v=20260828.37";
import {
  runHeadlessTask,
  tasksApi,
} from "./workspace-tasks-api.js?v=20260828.37";
import { agentsApi } from "./workspace-agents-api.js?v=20260828.1";
import { musicApi } from "./music-engine.js?v=20260829.5";
import {
  gcWorkspaceTasks,
  markAgentTaskStatus,
} from "./workspace-task-registry.js?v=20260828.37";
import { ensureGearShellBinds, GCTL_BIND } from "./gctl-bind.js?v=20260828.37";
