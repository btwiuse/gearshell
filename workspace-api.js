...
import {
  ...
  refreshW9yRegistry,
  removeW9yMod,
} from "./app-w9y-registry.js?v=20260830.41";
import {
  gcWorkspaceTasks,
  markAgentTaskStatus,
} from "./workspace-task-registry.js?v=20260828.135";
import { ensureGearShellBinds, GEAR_BIND } from "./gear-bind.js?v=20260828.135";
