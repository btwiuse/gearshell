...
import {
  terminalLayer, workspaceTaskSessions, iframeSessions, vmSessions,
  workbenchSessions, vmDriverInstallations, systemReady, getWanixRoot,
} from "./app-state.js?v=20260825.2";
import { WORKSPACE_TASK_STATUS_EVENT, HOME } from "./app-constants.js?v=20260825.2";
import { buildEnv, getDefaultTerminalProfile, terminalCommand } from "./app-terminal-profiles.js?v=20260825.2";
import { DEFAULT_CMD } from "./app-constants.js?v=20260825.2";
import { wanixSystem } from "./app-state.js?v=20260825.2";
import { createWanixBindElement } from "./app-wanix.js?v=20260825.2";
import { attachOverlayTerminalSession } from "./app-terminal-sessions.js?v=20260825.2";
...
export function attachWorkspaceTaskSession(id, taskDefinition, workspace, anchor, api) {
...
export function createIframeSession(id, { src, title, allow = DEFAULT_IFRAME_ALLOW, allowFullscreen = false }) {
  const wrapper = document.createElement('div');
