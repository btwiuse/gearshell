...
import { watch, unwatch, listWatchers } from "./workspace-fs-watch.js";
...
//
// These methods live in workspace-fs-watch.js (split for the 500-line
// rule). The FileSystemObserver + OPFS handle walking details stay there
// so a future change to the watch surface (debounce, multi-handle walks,
// non-OPFS paths) only edits one file.
