...
import {
  initCrushRunner,
} from "./plugin/crush-runner/crush-runner.js?v=20260826.136";
import { addLandingPanel, initHome } from "./plugin/home/home.js?v=20260812.33";
import {
  initSettings,
  TerminalPresetIconPicker,
} from "./plugin/settings/settings.js?v=20260826.134";

import { initFiles } from "./plugin/files/files-registry.js?v=20260826.106";
import { initRuntime } from "./plugin/runtime/runtime.js?v=20260826.51";
import {
  getPluginBootPromise,
  initPlugins,
  registerSyncPlugins,
} from "./plugins.js?v=20260829.104";
import { registerPluginsSettingsSection } from "./settings-plugins.js?v=20260829.114";
import {
  addPluginsPanel,
  initPluginsPanel,
} from "./plugins-panel.js?v=20260829.77";
...
import {
  ...
  initPanels,
} from "./panels.js?v=20260812.128";
import {
  ensureGearShellBinds,
  initWorkspaceApi,
  workspaceApi,
} from "./workspace-api.js?v=20260828.156";
import { ensurePluginToolBinds } from "./app-plugin-binds.js?v=20260830.62";
import { primePluginContentCache } from "./app-plugin-cache.js?v=20260830.2";
import { loadW9yRegistry, ensureW9yDependencies } from "./app-w9y-registry.js?v=20260830.31";
import {
  clearAuditEntries,
  listAuditEntries,
  undoAuditEntry,
} from "./workspace-audit.js?v=20260829.115";
import { App, PANEL_COMPONENTS } from "./app-shell.js?v=20260828.161";
...
import { createWanixSystem } from "./app-wanix.js?v=20260826.140";
import {
  addWorkspaceBind,
...
} from "./app-workspace-presets.js?v=20260826.140";
import {
  ...
  normalizeVmWispUrl,
} from "./app-normalize.js?v=20260828.141";
import {
  buildEnv,
...
import {
  ...
  wakeTerminalSession,
} from "./app-terminal-sessions.js?v=20260826.140";
import {
  attachIframeSession,
  attachVmSession,
  attachWorkbenchSession,
  waitForWanixSystem,
} from "./app-sessions.js?v=20260828.144";
import {
  attachWorkspaceTaskSession,
  getWorkspaceTaskSession,
  taskEnvLines,
  wakeWorkspaceTaskSession,
} from "./app-workspace-task-sessions.js?v=20260828.146";
import {
  getDockviewApi,
  rememberOpenPanel,
...
} from "./app-panels.js?v=20260826.141";
import {
