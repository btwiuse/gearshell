...
import { App } from "./app-shell.js?v=20260828.27";
...
import { createWanixSystem } from "./app-wanix.js?v=20260826.26";
import {
  addWorkspaceBind,
...
} from "./app-workspace-task-sessions.js?v=20260828.32";
import {
  getDockviewApi,
  rememberOpenPanel,
} from "./app-panels-store.js?v=20260826.26";
import {
