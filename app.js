...
import {
  initCrushRunner,
} from "./plugin/crush-runner/crush-runner.js?v=20260826.137";
import { addLandingPanel, initHome } from "./plugin/home/home.js?v=20260812.33";
import {
  initSettings,
  TerminalPresetIconPicker,
} from "./plugin/settings/settings.js?v=20260826.135";

import { initFiles } from "./plugin/files/files-registry.js?v=20260826.107";
...
import { registerPluginsSettingsSection } from "./settings-plugins.js?v=20260829.115";
import {
  addPluginsPanel,
  initPluginsPanel,
} from "./plugins-panel.js?v=20260829.78";
import { initDeck } from "./plugin/deck/deck.js?v=20260812.38";
...
import {
  ...
  initPanels,
} from "./panels.js?v=20260812.129";
import {
  ensureGearShellBinds,
  initWorkspaceApi,
  workspaceApi,
} from "./workspace-api.js?v=20260828.157";
import { ensurePluginToolBinds } from "./app-plugin-binds.js?v=20260830.63";
import { primePluginContentCache } from "./app-plugin-cache.js?v=20260830.2";
import { loadW9yRegistry, ensureW9yDependencies } from "./app-w9y-registry.js?v=20260830.32";
import {
  clearAuditEntries,
  listAuditEntries,
  undoAuditEntry,
} from "./workspace-audit.js?v=20260829.116";
import { App, PANEL_COMPONENTS } from "./app-shell.js?v=20260828.162";
...
import { createWanixSystem } from "./app-wanix.js?v=20260826.141";
import {
  addWorkspaceBind,
  ...
  updateWorkspaceTask,
} from "./app-workspace.js?v=20260826.141";
import {
...
} from "./app-workspace-presets.js?v=20260826.141";
import {
  ...
  normalizeVmWispUrl,
} from "./app-normalize.js?v=20260828.142";
import {
  buildEnv,
  ...
  terminalCommand,
} from "./app-terminal-profiles.js?v=20260826.141";
import {
  ...
  wakeTerminalSession,
} from "./app-terminal-sessions.js?v=20260826.141";
import {
  attachIframeSession,
  attachVmSession,
  attachWorkbenchSession,
  waitForWanixSystem,
} from "./app-sessions.js?v=20260828.145";
import {
  attachWorkspaceTaskSession,
  getWorkspaceTaskSession,
  taskEnvLines,
  wakeWorkspaceTaskSession,
} from "./app-workspace-task-sessions.js?v=20260828.147";
import {
  getDockviewApi,
  rememberOpenPanel,
} from "./app-panels-store.js?v=20260826.141";
import {
  blankTerminalPresetDraft,
  PANEL_CREATION_OPTIONS,
} from "./app-panels.js?v=20260826.142";
import {
