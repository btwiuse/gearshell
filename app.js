...
import {
  initCrushRunner,
} from "./plugin/crush-runner/crush-runner.js?v=20260826.143";
import { addLandingPanel, initHome } from "./plugin/home/home.js?v=20260812.34";
import {
  initSettings,
  TerminalPresetIconPicker,
} from "./plugin/settings/settings.js?v=20260826.141";

import { initFiles } from "./plugin/files/files-registry.js?v=20260826.113";
...
import { registerPluginsSettingsSection } from "./settings-plugins.js?v=20260829.121";
import {
  addPluginsPanel,
  initPluginsPanel,
} from "./plugins-panel.js?v=20260829.84";
...
import {
  ...
  initPanels,
} from "./panels.js?v=20260812.135";
import {
  ensureGearShellBinds,
  initWorkspaceApi,
  workspaceApi,
} from "./workspace-api.js?v=20260828.163";
import { ensurePluginToolBinds } from "./app-plugin-binds.js?v=20260830.69";
import { primePluginContentCache } from "./app-plugin-cache.js?v=20260830.2";
import { loadW9yRegistry, ensureW9yDependencies } from "./app-w9y-registry.js?v=20260830.38";
import {
  clearAuditEntries,
  listAuditEntries,
  undoAuditEntry,
} from "./workspace-audit.js?v=20260829.122";
import { App, PANEL_COMPONENTS } from "./app-shell.js?v=20260828.168";
...
import { createWanixSystem } from "./app-wanix.js?v=20260826.147";
import {
  addWorkspaceBind,
...
} from "./app-workspace-presets.js?v=20260826.147";
import {
  ...
  normalizeVmWispUrl,
} from "./app-normalize.js?v=20260828.148";
import {
  buildEnv,
...
import {
  ...
  wakeTerminalSession,
} from "./app-terminal-sessions.js?v=20260826.147";
import {
  attachIframeSession,
  attachVmSession,
  attachWorkbenchSession,
  waitForWanixSystem,
} from "./app-sessions.js?v=20260828.151";
import {
  attachWorkspaceTaskSession,
  getWorkspaceTaskSession,
  taskEnvLines,
  wakeWorkspaceTaskSession,
} from "./app-workspace-task-sessions.js?v=20260828.153";
import {
  getDockviewApi,
  rememberOpenPanel,
...
} from "./app-panels.js?v=20260826.148";
import {
...
} from "./app-constants.js?v=20260828.106";
