...
import { addFallbackPanel, initLauncher } from "./launcher.js?v=20260812.34";
import {
...
import { App } from "./app-shell.js?v=20260828.1";
...
import { createWanixSystem } from "./app-wanix.js?v=20260826.7";
import {
  addWorkspaceBind,
...
} from "./app-workspace-presets.js?v=20260826.7";
import {
...
import {
  ...
  wakeTerminalSession,
} from "./app-terminal-sessions.js?v=20260826.7";
import {
  attachIframeSession,
  attachVmSession,
...
import {
  getDockviewApi,
  rememberOpenPanel,
} from "./app-panels-store.js?v=20260826.7";
import {
  blankTerminalPresetDraft,
  IFRAME_PANEL_OPTIONS,
  PANEL_CREATION_OPTIONS,
} from "./app-panels.js?v=20260826.8";
import {
