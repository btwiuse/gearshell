...
export const LEGACY_DEFAULT_WORKBENCH_ASSETS_URL = 'https://wanix.dev/workbench';
export const DEFAULT_VM_BACKEND_URL = 'https://cdn.jsdelivr.net/npm/wanix-extras@0.4.0-rc2/dist/v86.tgz';
export const REDUNDANT_WISP_VM_BACKEND_URL = 'https://cdn.jsdelivr.net/gh/btwiuse/wanix-extras@85be99779bb8026bf3be64579b096c60b2c77c64/v86.tgz';
export const DEFAULT_VM_LINUX_URL = 'https://cdn.jsdelivr.net/npm/wanix-extras@0.4.0-rc2/dist/wanix-linux.tgz';
export const DEFAULT_COLLAPSED_LAUNCHER_ITEMS = ['deck', 'codigo', 'crush', 'rickroll'];
export const DEFAULT_LAUNCHER_ITEM_ORDER = ['terminal', 'home', 'deck', 'workbench', 'vm', 'settings', 'files', 'runtime', 'group', 'browser', 'bonsai', 'codigo', 'crush', 'crush-runner', 'rickroll'];
...
export const SUPPORTED_BIND_TYPES = ['ns', 'file', 'fetch', 'archive', 'import'];
export const SUPPORTED_SYSTEM_BIND_TYPES = ['ns', 'file', 'fetch', 'archive', 'import'];
export const SUPPORTED_UNION_MODES = ['after', 'before'];
export const SUPPORTED_TASK_TYPES = ['auto', 'gojs', 'wasi', 'js'];
export const STARTUP_PANEL_TYPES = ['home', 'deck', 'terminal', 'workbench', 'vm', 'settings', 'files', 'runtime', 'group', 'browser', 'bonsai', 'codigo', 'crush', 'crush-runner', 'rickroll'];
...
export const CANONICAL_LUCIDE_ICON_IDS = new Set(Object.keys(LucideIcons).map(lucideIconId));
